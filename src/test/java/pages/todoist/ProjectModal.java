...
public class ProjectModal {
    ...
    public Input newProjectNameInput = new Input(By.id("edit_project_modal_field_name"));
    public Button createNewProjectButton = new Button(By.xpath("//button[@class=\"ist_button ist_button_red\"]"));
